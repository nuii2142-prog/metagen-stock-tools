...
1. ดับเบิลคลิก [`metagen/MetaGen.html`](./metagen/MetaGen.html) — เปิดในเบราว์เซอร์ ไม่ต้องติดตั้งอะไร
...
- **shortcut เดิม** (เช่นที่หน้า Desktop) ที่ชี้ไปโฟลเดอร์เก่า ต้อง **ชี้มาที่ไฟล์ใหม่ในโฟลเดอร์นี้แทน**
  - MetaGen → `Fable Metagen\metagen\MetaGen.html`
